...
<head>
  ...
  <title>Daftar akun Masyarakat| Registration Page</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="themes/index2.html"><b>SIMPEL</b></a>
  </div>

  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Daftar akun masyarakat</p>

      <form action="masyarakat/proses.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" placeholder="Tulis username tanpa spasi">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
      ...
      <a href="/ukk/" class="text-center">Ke halaman Login</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
